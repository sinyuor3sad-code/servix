...
> [!CAUTION]
> ## ⚠️ وثيقة مؤرشفة — هذه الخطة أُلغيت ولا تعكس الواقع الحالي
>
> **تاريخ الأرشفة:** 2026-04-28
>
> هذه الوثيقة كُتبت في **20 أبريل 2026** وكانت تعتمد على بنية **n8n + Gemini** التي **أُلغيت كلياً**.
>
> **التغييرات الجوهرية التي جعلتها قديمة:**
>
> | ما تقوله الخطة | الواقع الحالي |
> |----------------|--------------|
> | n8n كـ orchestrator للـ AI | ❌ **أُلغي** — n8n.client.ts معطّل (CLAUDE.md: "لا تعيد ربطه") |
> | Gemini كـ AI أساسي | ❌ مُستبدَل — **GPT-5-nano/mini** هو الأساسي الآن |
> | AI عبر webhooks لـ n8n | ❌ مُستبدَل — AIProviderService يتصل بـ OpenAI مباشرة |
> | WhatsApp عبر n8n workflows | ❌ مُستبدَل — WhatsApp Evolution NestJS مباشر |
> | 4 workflows في tooling/n8n/ | ⚠️ موجودة لكن لا تُستخدم |
>
> **البديل المعتمد:** راجع `docs/features/AI_RECEPTION_V2_PLAN.md` — الخطة المُنفذة فعلياً (6 مراحل مكتملة ✅)
