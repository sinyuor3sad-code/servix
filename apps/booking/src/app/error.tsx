  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#fafafa]" dir="rtl">
      <div className="text-center px-4">
        ...
        <h1 className="mt-4 text-2xl font-bold text-gray-900">حدث خطأ غير متوقع</h1>
        <p className="mt-2 text-sm text-gray-500">نعتذر عن هذا الخطأ. يرجى المحاولة مرة أخرى.</p>
        <button
          onClick={reset}
